        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[240px]">
          ...
          >
            ...
            <div className="space-y-4 md:space-y-6 text-gray-400 leading-relaxed text-[15px] md:text-lg font-light">
              ...
              <p>
                I specialize in transforming raw machine intelligence into scalable, production-ready solutions. By leveraging advanced orchestration frameworks (<span className="text-white italic">LangChain, LlamaIndex</span>), powerful backend infrastructure (<span className="text-white italic">Python, FastAPI</span>), and cutting-edge vector databases (<span className="text-white italic">Pinecone, ChromaDB</span>), I engineer end-to-end pipelines that allow intelligent agents to interact fluidly with massive datasets.
              </p>
              <p>
                My core philosophy: <span className="text-emerald-300 font-medium tracking-wide">elegant AI architectures solve complex problems.</span>
              </p>
            </div>
          </motion.div>
          ...
          >
             ...
             <p className="text-lg md:text-xl text-white font-medium">Currently building highly-scalable LLM agents and actively seeking <span className="text-emerald-300">AI / Machine Learning Engineering Roles</span>.</p>
          </motion.div>
